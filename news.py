...
# ============================================================================================================
# FILTER → ข่าวเกี่ยวข้องกับ "ประเทศที่มีโครงการ" หรือไม่
# ============================================================================================================
def llm_filter(news):
    """
    ใช้ LLM ช่วยตอบว่า ข่าวนี้มีผลกระทบเชิงสาระสำคัญต่อ
    'ประเทศที่กลุ่ม ปตท.สผ. มีโครงการอยู่' หรือไม่
    (ดูที่ประเทศก่อน ไม่ต้องพูดชื่อโครงการตรง ๆ ก็ได้)
    """
    prompt = f"""
{PTT_CONTEXT}

บทบาทของคุณ: News Screener ของกลุ่ม ปตท.สผ.
หน้าที่: ตัดสินว่า “ข่าวนี้เกี่ยวข้องอย่างมีนัยสำคัญกับ
ประเทศที่กลุ่ม ปตท.สผ. มีโครงการอยู่หรือไม่”

ประเทศที่ต้องให้ความสนใจเป็นพิเศษ ได้แก่:
- ประเทศไทย / พื้นที่คาบเกี่ยว ไทย–มาเลเซีย
- เมียนมา
- มาเลเซีย
- เวียดนาม
- อินโดนีเซีย
...
ให้ตอบว่า “ใช่” ถ้ามีอย่างน้อยหนึ่งข้อดังนี้:
- ข่าวพูดถึงเหตุการณ์ด้านพลังงาน ก๊าซ น้ำมัน LNG โครงสร้างพื้นฐาน
  นโยบายรัฐ การกำกับดูแล หรือเศรษฐกิจ/การลงทุนในหนึ่งในประเทศข้างต้น
  และเหตุการณ์นั้นมีแนวโน้มส่งผลต่อการสำรวจ ผลิต ขนส่ง หรือลงทุนด้านพลังงาน
- ข่าวพูดถึงความเสี่ยงด้านการเมือง/ความมั่นคง/ความขัดแย้ง/คว่ำบาตร/ภัยพิบัติ
  ในหนึ่งในประเทศข้างต้น ที่อาจกระทบสภาพแวดล้อมการดำเนินธุรกิจพลังงาน
- ข่าวระดับภูมิภาคหรือโลก แต่กล่าวถึงประเทศเหล่านี้อย่างชัดเจน
  ในบริบทที่กระทบภาคพลังงานหรือเศรษฐกิจของประเทศนั้น

ให้ตอบว่า “ไม่ใช่” ถ้า:
- ข่าวไม่เกี่ยวข้องกับประเทศเหล่านี้เลย
- หรือข่าวอยู่ในประเทศเหล่านี้ แต่เป็นเรื่องทั่วไปที่แทบไม่เกี่ยวกับเศรษฐกิจ/พลังงาน
  เช่น กีฬา บันเทิง ไลฟ์สไตล์ ข่าวอุบัติเหตุเล็กน้อย เป็นต้น
...
# ============================================================================================================
# TAG ข่าว (สรุป + ประเทศ + โครงการที่เกี่ยวข้อง)
# ============================================================================================================
def gemini_tag(news):
    """
    ให้ LLM สรุปข่าว + ติดประเภทข่าว + ภูมิภาค +
    อธิบายผลกระทบต่อประเทศ/โครงการของกลุ่ม ปตท.สผ.
    โดยดู 'ประเทศก่อน' แล้วค่อยแม็ปไปที่โครงการ
    """
    schema = {
        "type": "object",
        "properties": {
...
วิธีคิด:
1) ดูก่อนว่าข่าวนี้เกี่ยวข้องกับ "ประเทศ" ใดบ้างในรายการด้านล่าง
   (ให้ใช้ชื่อประเทศภาษาไทยตามนี้)
   - ประเทศไทย / พื้นที่คาบเกี่ยว ไทย–มาเลเซีย
   - เมียนมา
   - มาเลเซีย
   - เวียดนาม
...
2) เมื่อรู้ประเทศแล้ว ให้ดูในบริบทโครงการด้านบนว่า
   ในแต่ละประเทศมี "โครงการ" อะไรบ้างของกลุ่ม ปตท.สผ.

3) ถ้าข่าวนี้มีแนวโน้มกระทบโครงการหนึ่งโครงการใดในประเทศนั้น
   (เช่น นโยบายก๊าซของประเทศ, ปัญหาด้านความมั่นคง, การลงทุนแหล่งก๊าซ,
   การเปลี่ยนแปลงสัมปทาน, ข่าวเกี่ยวกับแหล่งเดียวกัน ฯลฯ)
   ให้ใส่ชื่อโครงการนั้นลงใน related_projects
   - ใช้ชื่อโครงการให้ตรงกับที่ปรากฏใน PTT_CONTEXT
   - ถ้ามีหลายโครงการที่อาจได้รับผลกระทบ ก็ใส่ได้หลายชื่อ
   - ถ้าไม่แน่ใจว่าโครงการใดได้รับผลกระทบโดยตรง ให้ related_projects เป็น [] ว่าง

4) เขียน impact_reason และ relation_explanation ให้ชัดว่า
   - ข่าวนี้เกิดอะไร ที่ประเทศใด
   - และเชื่อมโยงกับโครงการใด/กลุ่มโครงการใด (ถ้ามี)
   - ถ้าเป็นผลกระทบเชิงอ้อม ให้ระบุว่าเป็น "เชิงอ้อม"
...
- impact_reason: เขียนเป็นภาษาไทยในรูปแบบ bullet หรือหลายบรรทัด
  (แต่ละบรรทัด = 1 ประเด็นผลกระทบ) ระบุให้เห็นชัดว่ากระทบ
  "ประเทศใด" และ "โครงการใด" (ถ้ามี)
- related_countries: เป็น list ของชื่อประเทศที่เกี่ยวข้องกับข่าวนี้
  เช่น ["โอมาน", "สหรัฐอาหรับเอมิเรตส์"]
- related_projects: เป็น list ของชื่อโครงการที่เกี่ยวข้องกับข่าวนี้
  โดยใช้ชื่อให้ตรงกับรายชื่อในบริบทด้านบน
- relation_explanation: อธิบายเป็นย่อหน้าเดียวว่า
  ข่าวนี้เกี่ยวข้องกับประเทศ/โครงการที่ระบุอย่างไร
  เช่น กระทบซัพพลายก๊าซของประเทศนั้น, เสี่ยงต่อการลงทุนในโครงการ X,
  หรือเป็นโอกาสขยายการลงทุน ฯลฯ
...
เป้าหมาย: อ่านบับเบิลนี้แล้วเข้าใจว่าในประเด็นนี้ (topic + region) มีอะไรเกิดขึ้นกับประเทศ/โครงการของกลุ่ม ปตท.สผ. บ้าง
...
- impact_reason: สรุปเป็น bullet หรือหลายบรรทัดว่า กลุ่มข่าวนี้กระทบประเทศ/โครงการต่าง ๆ
...
{{
  ...
  "impact_reason": "<ผลกระทบต่อประเทศ/โครงการของกลุ่ม ปตท.สผ. เป็น bullet/หลายบรรทัด>"
}}
"""
...
def create_flex(news_items):
    ...
    for n in news_items:
        ...
        # เตรียมข้อความประเทศที่เกี่ยวข้อง
        countries = n.get("related_countries") or []
        if isinstance(countries, list):
            countries_txt = ", ".join(countries[:3])  # กันยาวเกิน
        else:
        ...
        bubble = {
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {
                        "type": "text",
                        "text": f"ประเทศที่เกี่ยวข้อง: {countries_txt}",
                        "size": "xs",
                        "color": "#555555",
                        "wrap": True,
                        "margin": "sm",
...
def main():
    ...
    print(f"จำนวนข่าวดิบที่ดึงได้: {len(all_news)}")
    ...
    print(f"ผ่าน filter (ประเทศที่มีโครงการ): {len(filtered)} ข่าว")

    if not filtered:
        print("ไม่มีข่าวเกี่ยวข้องกับประเทศที่มีโครงการ")
        return

    print("วิเคราะห์ข่าวด้วย LLM (tag ประเทศ/โครงการ)...")
    tagged = []
    for n in filtered:
        tag = gemini_tag(n)
    ...
    # รวม countries / projects สำหรับ group
    for g in grouped:
        if g.get("is_group"):
    ...
    print(f"จำนวนข่าวหลังตัดของที่เคยส่งแล้ว: {len(final)}")
